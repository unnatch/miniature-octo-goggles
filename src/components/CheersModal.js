...
export default class CheersModal extends React.Component {
  constructor(props) {
    super(props);
    this.state = {
      modal: false,
  ...
  render() {
    return (
      ...
      <Button color="light" className="col-12 p-2 mx-2 d-flex flex-column align-items-center justify-content-end" onClick={this.toggle}>
        <span>HK$ 3900</span><span>CHEERS</span>
      </Button> 
      <Modal isOpen={this.state.modal} toggle={this.toggle}>
        <ModalHeader toggle={this.toggle}>Cheers<div className="col-12 border-bottom">
